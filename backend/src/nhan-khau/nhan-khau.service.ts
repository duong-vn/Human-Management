...
export class NhanKhauService {
  ...
  async findAll(query?: {
    ...
    const filter: FilterQuery<NhanKhauDocument> = {};
    if (query?.hoKhauId) {
    ...
    return this.nhanKhauModel.find(filter).lean().exec() as unknown as Promise<NhanKhau[]>;
  }
  ...
  async findOne(id: string): Promise<NhanKhau | null> {
    return this.nhanKhauModel
      ...
      .populate('hoKhauId')
      .lean()
      .exec() as unknown as Promise<NhanKhau | null>;
  }
  ...
  async findByHoKhau(hoKhauId: string): Promise<NhanKhau[]> {
    return this.nhanKhauModel
      ...
      .populate('hoKhauId')
      .lean()
      .exec() as unknown as Promise<NhanKhau[]>;
  }
